        ...
        <header className='bg-white shadow-sm sticky top-0 z-50 border-b border-gray-100'>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className='text-xl md:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-violet-600'>EduPortal</h1>
                </div>

                <nav className='flex items-center gap-2 md:gap-6'>
                    {user ? (
                        <>
                            {role === "student" && <Link to="/students" className="text-sm md:text-base font-medium text-gray-600 hover:text-indigo-600 transition-colors">Student Hub</Link>}
